...
public enum OWLSymb implements OWLAtom{
	...
	OBJECTMINCARDINALITY, OBJECTMAXCARDINALITY, OBJECTEXACTCARDINALITY,DATAMINCARDINALITY, DATAMAXCARDINALITY, DATAEXACTCARDINALITY, CLASSASSERTION, OBJECTPROPERTYASSERTION; 

...
public enum OWLSymb implements OWLAtom{
	...
	OBJECTMINCARDINALITY, OBJECTMAXCARDINALITY, OBJECTEXACTCARDINALITY,DATAMINCARDINALITY, DATAMAXCARDINALITY, DATAEXACTCARDINALITY, SYMMETRICOBJECTPROPERTY, ASYMMETRICOBJECTPROPERTY; 

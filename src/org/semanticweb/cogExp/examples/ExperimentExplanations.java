...
public class ExperimentExplanations {
	...
	public static ProofTree constructProoftree(String conclusion, String justifications, String ontologyfilestring){
		...
		for(OWLAxiom just:justifications1axioms){
			try {
				...
				System.out.println(VerbalisationManager.verbalise(just));
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	// Explanation 2
		...
		try {
			org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree3, prooftree.getRoot().getId());
		// node.getId());
			...
			e.printStackTrace();
				...
				try {
					org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree4, prooftree.getRoot().getId());
				// node.getId());
					...
					try {
						org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree5, prooftree.getRoot().getId());
								// node.getId());
...
// Explanation 7 
					...
					*/
					...
					try {
						org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree8, prooftree.getRoot().getId());
								// node.getId());
						GentzenTree gentzenTree8 = prooftree8.toGentzen();	
						System.out.println(VerbaliseTreeManager.listOutput(gentzenTree8));
						System.out.println();
						System.out.println(VerbaliseTreeManager.verbaliseNL(gentzenTree8, true, false,false,null));
...
// Explanation 9 (similar to 6) 
					...
					try {
						org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree9, prooftree.getRoot().getId());
								// node.getId());
...
// Explanation 10
					...
					try {
						...
						System.out.println(VerbaliseTreeManager.listOutput(gentzenTree10));
						System.out.println();
						System.out.println(VerbaliseTreeManager.verbaliseNL(gentzenTree10, true, false,false,null));
...
// Explanation 11 (opengalen-no-propchains)
					...
					try {
						org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree11, prooftree.getRoot().getId());
								// node.getId());
						GentzenTree gentzenTree11 = prooftree11.toGentzen();	
						System.out.println(VerbaliseTreeManager.listOutput(gentzenTree11));
						System.out.println();
						System.out.println(VerbaliseTreeManager.verbaliseNL(gentzenTree11, true, false,false,null));
...
// Explanation 12 (tambis-patched)
					...
					try {
						org.semanticweb.cogExp.core.InferenceApplicationService.INSTANCE.eliminateIrrelevantParts(prooftree12, prooftree.getRoot().getId());
								// node.getId());
						GentzenTree gentzenTree12 = prooftree12.toGentzen();	
						System.out.println(VerbaliseTreeManager.listOutput(gentzenTree12));
						System.out.println();
						System.out.println(VerbaliseTreeManager.verbaliseNL(gentzenTree12, true, false,false,null));
